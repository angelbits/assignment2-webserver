...
def webServer(port=13331):
  ...
  while True:
    ...
    try:
      ...
      print(message) #message: GET /helloworld.html HTTP/1.1
      filename = message.split()[1]
      print(filename) #prints: /helloworld.html
      ...
      for i in f: #for line in file
        #print(i) #printed every line in terminal
        connectionSocket.send(i.encode())#Fill in start - send your html file contents #Fill in end
